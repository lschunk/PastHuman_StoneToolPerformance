...
ggsave(filename = file_out, plot = cutting, path = dir_out, device = "pdf", width = 170, height = 250, units = "mm")
...
# combine the flint and the lydite plots 
carving <- f_carving_v + f_carving_w + l_carving_v + l_carving_w + plot_layout(width = c(3/6, 3/6), guides = 'collect')  
